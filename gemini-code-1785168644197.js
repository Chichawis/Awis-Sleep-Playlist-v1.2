...
function storyTemplate(story) {
  ...
  const favoriteIcon = story.favorite ? icons.heart : icons.heartOutline;
  ...
  return `
    <article class="story-card ${isActive ? "active" : ""}">
      ...
      <div class="story-actions">
        <button class="story-action favorite" type="button" data-action="favorite" data-id="${story.id}" aria-label="Cambiar favorito" title="Favorito">${favoriteIcon}</button>
        ${adminActions}
      </div>
    </article>
  `;
